...
> Comportamiento (foco, teclado, cuando abrir): se preserva el de la vista existente tal cual
> (regla de restyle-view); el estilo del foco visible sigue `refinement.md`. Aca, las primitivas.
